...
const StudentDashboard = () => {
  ...
  useEffect(() => {
    ...
    const load = async () => {
      ...
      setError("");
      try {
        const [quizData, boardData, resultData] = await Promise.all([
          getQuizzes(),
          getLeaderboard(),
          getMyResults(),
        ]);
  ...
  const getDifficultyColor = (difficulty) => {
    switch (difficulty?.toLowerCase()) {
      case "easy":
        return "sd-difficulty-easy";
      case "medium":
        return "sd-difficulty-medium";
      case "hard":
        return "sd-difficulty-hard";
      default:
        return "sd-difficulty-medium";
    }
  };
  ...
  return (
    <>
      <style>{`
        /* ===========================================
           EDUNEXUS STUDENT DASHBOARD - LIGHT SOFT THEME
           =========================================== */
        ...
        .sd-bg-gradient {
          ...
          background: 
            ...
            radial-gradient(ellipse 50% 50% at 90% 20%, rgba(139, 92, 246, 0.06), transparent),
            radial-gradient(ellipse 50% 50% at 10% 80%, rgba(16, 185, 129, 0.05), transparent);
        }
        ...
        .sd-quiz-action:hover {
          ...
          box-shadow: 0 5px 20px -5px rgba(6, 182, 212, 0.35);
        }
            ...
            <div className="sd-navbar-links">
              {studentLinks.map((link, index) => (
                <a
                  ...
                  className={`sd-navbar-link ${
                    index === 0 ? "sd-navbar-link-active" : ""
                  }`}
                >
                  {link.label}
                </a>
            ...
            <div className="sd-hero-content">
              <div className="sd-hero-text">
                ...
                <h1 className="sd-hero-title">
                  Welcome back,{" "}
                  <span className="sd-hero-title-highlight">
                    {user?.name || "Learner"}
                  </span>
                </h1>
                <p className="sd-hero-subtitle">
                  Continue your learning journey. Attempt quizzes, climb the
                  leaderboard, and earn eco points along the way.
                </p>
                          ...
                          >
                            ...
                            <div className="sd-quiz-info">
                              ...
                              <div className="sd-quiz-meta">
                                ...
                                <span
                                  className={`sd-difficulty ${getDifficultyColor(
                                    quiz.difficulty
                                  )}`}
                                >
                    ...
                    <>
                      <div className="sd-leaderboard-list">
                        {leaderboard.slice(0, 5).map((entry, index) => (
                          <div
                            key={entry._id || index}
                            className={`sd-leaderboard-item ${
                              entry.name === user?.name ? "sd-me" : ""
                            }`}
                          >
                            <div
                              className={`sd-leaderboard-rank ${
                                index === 0
                                  ? "sd-rank-1"
                                  : index === 1
                                  ? "sd-rank-2"
                ...
                <div className="sd-panel">
                  ...
                  <div className="sd-quick-actions">
                    {quickActions.map((action) => (
                      ...
                      >
                        <span className="sd-quick-btn-icon">
                          {action.icon}
                        </span>
                        <span className="sd-quick-btn-label">
                          {action.label}
                        </span>
                      </button>
                    ))}
